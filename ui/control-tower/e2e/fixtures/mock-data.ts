...
// CVE Alerts Mock Data
export const mockCVEAlertsSummary = {
  total_alerts: 24,
  new_alerts: 5,
  in_progress_alerts: 12,
  resolved_alerts: 7,
  critical_alerts: 3,
  high_alerts: 8,
  medium_alerts: 9,
  low_alerts: 4,
  sla_breached_alerts: 2,
  exploitable_alerts: 6,
  cisa_kev_alerts: 4,
  average_urgency_score: 68,
  total_affected_assets: 156,
  production_affected_assets: 42,
};

export const mockCVEAlerts = {
  alerts: [
    {
      id: "alert-1",
      org_id: "org-1",
      ...
      status: "new",
      priority: "p1",
      sla_due_at: "2024-01-17T12:00:00Z",
      sla_breached: false,
      affected_images_count: 8,
      affected_assets_count: 24,
      affected_packages_count: 1,
      production_assets_count: 12,
      ...
      cve_details: {
        ...
        description: "Container escape vulnerability in runc allowing breakout to host",
        published_date: "2024-01-15T00:00:00Z",
        remediation_summary: "Upgrade runc to version 1.1.12 or later",
      },
    },
    {
      id: "alert-2",
      ...
      priority: "p2",
      sla_due_at: "2024-01-18T12:00:00Z",
      sla_breached: false,
      affected_images_count: 5,
      affected_assets_count: 18,
      affected_packages_count: 1,
      production_assets_count: 6,
      assigned_to: "user-1",
      ...
      cve_details: {
        ...
        description: "GnuTLS certificate verification bypass",
        published_date: "2024-01-10T00:00:00Z",
        remediation_summary: "Upgrade GnuTLS to version 3.8.3 or later",
      },
    },
    {
      id: "alert-3",
      ...
      status: "in_progress",
      priority: "p1",
      sla_due_at: "2024-01-17T18:00:00Z",
      sla_breached: false,
      affected_images_count: 12,
      affected_assets_count: 45,
      affected_packages_count: 1,
      production_assets_count: 18,
      patch_campaign_id: "campaign-1",
      ...
      cve_details: {
        ...
        exploit_available: true,
        cisa_kev_listed: true,
        description: "Linux kernel privilege escalation via netfilter",
        published_date: "2024-01-12T00:00:00Z",
        remediation_summary: "Upgrade kernel to 6.7.1, 6.6.14, 6.1.75, or later",
      },
    },
    {
      id: "alert-4",
      ...
      status: "new",
      priority: "p3",
      sla_due_at: "2024-01-20T12:00:00Z",
      sla_breached: false,
      affected_images_count: 3,
      affected_assets_count: 8,
      affected_packages_count: 1,
      production_assets_count: 2,
      detected_at: "2024-01-16T06:00:00Z",
      ...
      cve_details: {
        ...
        exploit_available: false,
        cisa_kev_listed: false,
        description: "RSA-PSK key exchange timing side channel",
        published_date: "2024-01-08T00:00:00Z",
        remediation_summary: "Upgrade GnuTLS to version 3.8.2 or later",
      },
    },
  ],
  total: 24,
...
export const mockCVEAlertDetail = {
  ...mockCVEAlerts.alerts[0],
  affected_items: [
    {
      id: "item-1",
      alert_id: "alert-1",
  ...
  affected_regions: ["us-east-1", "us-west-2", "westeurope"],
};
  ...
  affected_images: [
    {
      ...
      is_direct: true,
      lineage_depth: 0,
      child_image_ids: ["image-3", "image-5"],
    },
    {
      image_id: "image-3",
      image_family: "ql-app-server",
      image_version: "2.1.0",
      is_direct: false,
      inherited_from: "image-1",
      lineage_depth: 1,
    },
  ],
  affected_assets: [
    ...
    {
      asset_id: "asset-3",
      asset_name: "app-server-staging-01",
      platform: "azure",
      region: "westeurope",
      environment: "staging",
      is_production: false,
...
// Patch Campaigns Mock Data
export const mockPatchCampaignsSummary = {
  total_campaigns: 12,
  active_campaigns: 3,
  completed_campaigns: 8,
  failed_campaigns: 1,
  total_assets_patched: 487,
  total_rollbacks: 2,
  success_rate: 94.5,
};

export const mockPatchCampaigns = {
  campaigns: [
    {
      id: "campaign-1",
      org_id: "org-1",
      name: "Critical CVE-2024-1086 Remediation",
      description: "Emergency patch for Linux kernel privilege escalation",
      campaign_type: "cve_response",
      cve_alert_ids: ["alert-3"],
      status: "in_progress",
    ...
    },
    {
      id: "campaign-2",
      org_id: "org-1",
      name: "Monthly Security Patches - January 2024",
      description: "Scheduled monthly security patch deployment",
      ...
      failed_assets: 0,
      skipped_assets: 0,
      scheduled_start_at: "2024-01-20T02:00:00Z",
      created_by: "user-2",
      created_at: "2024-01-14T14:00:00Z",
    ...
    },
    {
      id: "campaign-3",
      org_id: "org-1",
      name: "OpenSSL CVE-2024-0567 Patch",
      description: "GnuTLS security update",
      campaign_type: "cve_response",
      cve_alert_ids: ["alert-2"],
      status: "completed",
      requires_approval: true,
      approved_by: "user-1",
      approved_at: "2024-01-12T08:00:00Z",
      rollout_strategy: "canary",
      canary_percentage: 5,
      wave_percentage: 25,
      failure_threshold_percentage: 5,
...
export const mockPatchCampaignPhases = {
...
export const mockPatchCampaignProgress = {
  campaign_id: "campaign-1",
  status: "in_progress",
  total_assets: 45,
  completed_assets: 18,
  ...
  failure_percentage: 4.4,
  total_phases: 4,
  completed_phases: 2,
  current_phase: "Wave 2",
  current_phase_progress: 33.3,
  estimated_completion: "2024-01-16T18:00:00Z",
  started_at: "2024-01-15T11:00:00Z",
  elapsed_time_minutes: 1500,
};
