  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        // Brand button with gradient
        brand:
          "gradient-brand text-white shadow-md hover:shadow-lg hover:brightness-110 transition-all duration-200",
        // AI action button with gradient
        ai:
          "gradient-ai text-white shadow-md hover:shadow-lg hover:brightness-110 transition-all duration-200",
        // Success action button
        success:
          "bg-status-green text-white hover:bg-status-green/90 shadow-sm hover:shadow-md",
        // Warning action button
        warning:
          "bg-status-amber text-white hover:bg-status-amber/90 shadow-sm hover:shadow-md",
      },
      size: {
